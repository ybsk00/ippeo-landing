...
export default function LandingPageKo() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-[#F3E6DF]" style={{ fontFamily: "'Noto Sans KR', 'Inter', sans-serif" }}>
